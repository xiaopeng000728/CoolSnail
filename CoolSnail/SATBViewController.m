//
//  SATBViewController.m
//  Snail
//
//  Created by teacher on 15-4-1.
//  Copyright (c) 2015年 牵着蜗牛走的我. All rights reserved.
//

#import "SATBViewController.h"
#import "SATabBar.h"
#import "UINavigationItem+LXP.h"
@interface SATBViewController ()<SATabBarDelegate>
{
    SATabBar *_myTabBar;
}
@end

@implementation SATBViewController
...
#pragma mark  实现协议方法
-(void)tabBar:(SATabBar *)tabBar didSelectItemFrom:(NSUInteger)from to:(NSUInteger)to
{
